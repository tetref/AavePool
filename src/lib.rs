...
#[derive(Debug)]
pub struct AavePoolProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AavePoolProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AavePool processing");
    
    let mut processor = AavePoolProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AavePoolProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AavePoolProcessor::new(false);
